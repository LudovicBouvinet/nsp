...
class Photo
{
    ...
    // toute les fonctions suivantes (annotées) s'executeront automatiquement grâce aux anotations lors des événements correspondants (Rappel : du coup j'ai supprimé la ligne qui les appelaient dans le controleur car on n'en a plus besoin)
